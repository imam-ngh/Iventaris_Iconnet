    ...
    try {
        ...
        await db.query(
            `UPDATE inventory SET
             ...
             WHERE id = $14`,
            [
                updated.name, updated.merk, updated.sn, updated.updated_sn_converter || updated.sn_converter, 
...
app.post('/api/inventory/check', async (req, res) => {
    ...
    try {
        ...
        if (!isAlreadyChecked) {
            ...
            const updatedResult = await db.query('SELECT * FROM inventory WHERE id = $1', [item.id]);
