...
- **Bulk Selection & Addition**: Memilih banyak kubikel sekaligus dari daftar dan menambahkannya ke kanvas dalam formasi grid otomatis.
...
- **Real-time Dashboard Map**: Tampilan denah di dashboard kini lebih cerdas dengan ikon perangkat (Laptop/PC) dan label teks yang akurat.
